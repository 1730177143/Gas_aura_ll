...
演示视频: **demoVideo.mp4** https://www.bilibili.com/video/BV1T1Tm6YEFr/
![demoVideo.mp4](https://www.bilibili.com/video/BV1T1Tm6YEFr/)
...
1. 类似于主角的ProjectileSpell技能，为敌方角色创建一个GA蓝图[GA_Rock]，蓝图的父类为ProjectileSpell。
...
5. \#####开始设置视觉效果#####
6. 创建攻击蒙太奇，配置[MotionWraping]，添加动画通知，发送特定标签A。在敌人角色蓝图中，配置特定标签A对应的蒙太奇，方便后续GA查，配置武器插槽方便生成Rock Actor。
